...
and flag =
  (* Constant constructors -- indices MUST match karamel/lib/Common.ml
     because the .krml binary uses OCaml Marshal. *)
  | Private       (* 0 *)
  | WipeBody      (* 1 *)
  | CInline       (* 2: Inline in Karamel *)
  | Substitute    (* 3 *)
  | GCType        (* 4: GcType in Karamel *)
  | MustDisappear (* 5 *)
  | Abstract      (* 6: AbstractStruct in Karamel *)
  | IfDef         (* 7 *)
  | Macro         (* 8 *)
  | CNoInline     (* 9: NoInline in Karamel *)
  | Internal      (* 10: padding -- not used by F* *)
  | AutoGenerated (* 11: padding -- not used by F* *)
  | MaybeUnused   (* 12: padding -- not used by F* *)
  | Verbatim      (* 13: suppress declaration, keep Prologue/Epilogue *)
  (* Non-constant constructors -- indices MUST also match *)
  | Comment of string     (* 0 *)
  | Const of string       (* 1 *)
  | Prologue of string    (* 2 *)
  | Epilogue of string    (* 3 *)
  | Deprecated of string  (* 4 *)
  | Target of string      (* 5 *)
  | Section of string     (* 6 *)
...
instance pretty_flag = { pp = function
  ...
  | Internal -> doc_of_string "Internal"
  | AutoGenerated -> doc_of_string "AutoGenerated"
  | MaybeUnused -> doc_of_string "MaybeUnused"
  | Verbatim -> doc_of_string "Verbatim"
...
let translate_flags flags =
  List.choose (function
    ...
    | Syntax.CVerbatim -> Some Verbatim
